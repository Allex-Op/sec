package pt.ulisboa.tecnico.sec.services.keys;
...
public class keystoreCreator {
    ...
    static String keystorePath = "/home/allex/Secure-Communication/services/src/main/resources/secKeystore.jks";
    ...
    private static void createKeyStore() {
        try {
            ...
            try (FileOutputStream fos = new FileOutputStream("secKeystore.jks")) {
